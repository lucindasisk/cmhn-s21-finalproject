...
if __name__ == '__main__':
    ...
    np.savetxt(X = predict, fname = '/gpfs/milgram/scratch60/gee_dylan/lms233/cmhn2021/cmhn-s21-finalproject/image_data/fcma_outdata/predicted_output_{}.txt'.format(int(left_out_subj)))
    np.savetxt(X = predict, fname = '/gpfs/milgram/scratch60/gee_dylan/lms233/cmhn2021/cmhn-s21-finalproject/image_data/fcma_outdata/flabels_output_{}.txt'.format(int(left_out_subj)))
